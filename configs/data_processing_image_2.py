...
# === 0. 设置代理（如果你使用远程模型或需访问 HuggingFace）===
os.environ["HTTP_PROXY"] = "http://127.0.0.1:60001"
os.environ["HTTPS_PROXY"] = "http://127.0.0.1:60001"
os.environ["ALL_PROXY"] = "socks5://127.0.0.1:60001"

# === 1. 加载 JSON 数据（包含 image_path 和文本信息） ===
with open('/home/Userlist/kongzicheng/omni-critic-r1/selected preference dataset/image/doubao_image_llava_qwen_output.json', 'r') as f:
...
dataset = Dataset.from_dict({
    ...
    "llava1_5_vl_7b_output": [entry["llava1_5_vl_7b_output"] for entry in json_data],
...
def preprocess_data(example):
    ...
    question_encoding = tokenizer(example['question'], truncation=True, padding="max_length", max_length=1024)
    answer_3b_encoding = tokenizer(example['llava1_5_vl_7b_output'], truncation=True, padding="max_length", max_length=1024)
    ...
    return {
        ...
        'answer_llava': answer_3b_encoding,
        'answer_qwen': answer_7b_encoding,
...
# === 10. 保存至磁盘 ===
output_dir = '/home/Userlist/kongzicheng/omni-critic-r1/OmniCritic-SFT/sft_dataset/image/llava_qwen'
